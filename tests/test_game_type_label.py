...
from scadustats.game_type_label import (
...
def test_majority_game_type_label_returns_none_when_no_frame_votes(monkeypatch):
    monkeypatch.setattr("scadustats.game_type_label.read_game_type_label", lambda frame: None)
...
def test_majority_game_type_label_picks_the_most_common_vote(monkeypatch):
    ...
    monkeypatch.setattr(
        "scadustats.game_type_label.read_game_type_label", lambda frame: next(votes)
    )
