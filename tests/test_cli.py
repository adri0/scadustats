...
from scadustats.cli import _prompt_match_date, _prompt_match_metadata
...
def test_prompt_match_metadata_uses_supplied_options_without_prompting(monkeypatch):
    ...
    metadata = _prompt_match_metadata("2026-03-05", 6, MatchType.PLAYOFFS)
...
def test_prompt_match_metadata_defaults_season_from_match_date(monkeypatch):
    ...
    metadata = _prompt_match_metadata("2029-01-01", None, MatchType.DOUBLE_ELIMINATION)
